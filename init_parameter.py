...
def init_model():
    ...
    parser.add_argument("--bert_model", default="bert", type=str, help="The path for the pre-trained bert model.")
    ...
    parser.add_argument("--lr_boundary", type=float, default=1e-5, help="The learning rate of the decision boundary.")
